<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="formProperties">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="img" placeholder="Imagen" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="btnSubmit" form="formProperties" class="btn btn-primary">Guardar Cambios</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.10.2/dist/umd/popper.min.js" integrity="sha384-BAP6MR6AuMTqq3iAq5E51Dw2spHtzeXJK3xvZxMBYbBkzRJb/sHf5BiJqJfZQ+8V" crossorigin="anonymous"></script>
