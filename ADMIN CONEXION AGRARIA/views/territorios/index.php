    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formProperties">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <label for="img">CLIMA</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="departamento" placeholder="Departamento" required>
                        <label for="img">DEPARTAMENTO</label>
                    </div>
                    <!-- Campos para los nombres de las imágenes -->
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="imagenes" placeholder="Nombres de Imágenes"
                            required>
                        <label for="imagenes">Imagenes</label>
                        <small class="form-text text-muted">Separar los nombres con comas (,)</small>
                    </div>
                    <!-- Campo para los IDs de los usuarios -->
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="usuarios" placeholder="IDs de Usuarios" required>
                        <label for="usuarios">Propietario(s)</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="btnSubmit" form="formProperties" class="btn btn-primary">Guardar
                    Cambios</button>
            </div>
        </div>
    </div>
